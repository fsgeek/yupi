...
> **Pointer (2026-09-03 11:27 PDT):** held-out confirmatory search for witness 11 done under the pre-registered reading (`w11-heldout-prereg-v0.1.md`, stamped before the run): **thresholded witness SATISFIED on a held-out law** — F2 (14,2,2) ε=¼ r3→r4, kinds2 TV ≈ 0.0112 ≥ Δ_τ, mass 1.2×10⁻⁸; P1/P4/P5 PASS, P2/P3/P6 FAIL as scored (`w11-heldout-confirmation-v0.1.md`). Witness-table row 11 now reads: SATISFIED (existence, exact, statutory and held-out ε; thresholded at ε=¼), a corner (10⁻⁸–10⁻⁶ of law mass), mechanism κ. Part C evidence set unchanged. The Part C intervention discussion is informed by `c1-residual-ambiguity-census-v0.1.md` (§5 candidates; §7 the exposure-side range check closes the "question the metric" option). Nothing above is rewritten.
